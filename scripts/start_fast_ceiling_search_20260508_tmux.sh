...
active_blockers() {
  ...
  tmux has-session -t demo_action_sweep_traj_local_20260508 2>/dev/null && return 0
  tmux has-session -t demo_action_sweep_traj_replay_20260508 2>/dev/null && return 0
  ...
  pgrep -f "scripts/eval_demo_trajectory_policy_live.py" >/dev/null 2>&1 && return 0
